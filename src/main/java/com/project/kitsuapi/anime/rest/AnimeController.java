...
import com.project.kitsuapi.anime.response.InformacoesAnime;
...
public class AnimeController {
	...
	public ResponseEntity<List<AnimeResponse>> recuperarAnimesPopulares() {
		return ResponseEntity.ok(animeService.recuperarAnimesMaisPopulares());
	}
	...
	public ResponseEntity<List<AnimeResponse>> recuperarInformacoesAnimes(
		...
		return ResponseEntity.ok(animeService.recuperarInformacoesAnimes(id, Type));
	}
	...
	public ResponseEntity<EpisodioResponse> recuperarAnimesPorId(
		@RequestParam(name = "id", required = false) Integer id){
		return ResponseEntity.ok(animeService.recuperarEpisodioAnimesPorId(id));
	}
}
